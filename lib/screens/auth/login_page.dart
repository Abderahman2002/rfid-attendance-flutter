...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> login() async {
    ...
    try {
      ...
      if (role.isEmpty)  throw Exception("Rôle manquant");
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        backgroundColor: Colors.red, content: Text("Erreur: $e")));
    } finally {
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.person_outline, color: Color(0xFF0039CB)),
                          filled: true, fillColor: const Color(0xFFF8F9FA),
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12),
                              borderSide: BorderSide.none),
                          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12),
                              borderSide: const BorderSide(color: Color(0xFF0039CB), width: 2)),
                        ),
                      ),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.grey.shade400),
                          prefixIcon: const Icon(Icons.lock_outline, color: Color(0xFF0039CB)),
                  ...
                  SizedBox(
                    width: 420,
                    child: Row(children: [
                      Expanded(child: _infoCard(Icons.nfc, "NFC", "Scan auto")),
                      const SizedBox(width: 12),
                      Expanded(child: _infoCard(Icons.bar_chart, "Stats", "Temps réel")),
                      const SizedBox(width: 12),
                      Expanded(child: _infoCard(Icons.picture_as_pdf, "PDF", "Rapports")),
                    ]),
                  ),
